...
srcdir=		Python-3.6.9
VPATH=		Python-3.6.9
abs_srcdir=	/content/drive/MyDrive/dcx_mid_project/DCX_Mid_Project/Python-3.6.9
abs_builddir=	/content/drive/MyDrive/dcx_mid_project/DCX_Mid_Project
...
CONFIGURE_CFLAGS_NODIST= -std=c99 -Wextra -Wno-unused-result -Wno-unused-parameter -Wno-missing-field-initializers -Wno-cast-function-type
