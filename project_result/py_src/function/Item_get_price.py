...
def itemPrice(name, weight):
    ...
    if name == '감자':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 152, 'dpr1'])
    ...
    if name == '양파':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 245, 'dpr1'])
    ...
    if name == '대파':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 246, 'dpr1'])
    ...
    if name == '고추':
        ...
        priceN = round(weight * df_data.loc[df_data['item_name'] == '풋고추 청양고추(100g)', 'dpr1'])
    ...
    if name == '계란':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 9903, 'dpr1'])
    ...
    if name == '배추':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 211, 'dpr1'])
    ...
    if name == '무':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 231, 'dpr1'])
    ...
    if name == '당근':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 232, 'dpr1'])
    ...
    if name == '마늘':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 258, 'dpr1'])
    ...
    if name == '고구마':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 151, 'dpr1'])
    ...
    if name == '상추':
        ...
        priceN = round(weight * df_data.loc[df_data['item_name'] == '상추 청(100g)', 'dpr1'])
    ...
    if name == '오이':
        ...
        priceN = round(weight * df_data.loc[df_data['item_name'] == '오이 다다기계통(10개)', 'dpr1'])
    ...
    if name == '토마토':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 225, 'dpr1'])
    ...
    if name == '고춧가루':
        ...
        priceN = round(weight * df_data.loc[df_data['item_name'] == '고춧가루 국산(1kg)', 'dpr1'])
    ...
    if name == '버섯':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 317, 'dpr1'])
    ...
    if name == '앞다리':
        ...
        priceN = round(weight * df_data.loc[df_data['item_name'] == '돼지 앞다리', 'dpr1'])
    ...
    if name == '삼겹살':
        ...
        priceN = round(weight * df_data.loc[df_data['item_name'] == '돼지 삼겹살', 'dpr1'])
    ...
    if name == '갈비':
        ...
        priceN = round(weight * df_data.loc[df_data['item_name'] == '돼지 갈비', 'dpr1'])
    ...
    if name == '목심':
        ...
        priceN = round(weight * df_data.loc[df_data['item_name'] == '돼지 목심', 'dpr1'])
    ...
    if name == '고등어':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 611, 'dpr1'])
    ...
    if name == '갈치':
        ...
        priceN = round(weight * df_data.loc[df_data['item_code'] == 613, 'dpr1'])
