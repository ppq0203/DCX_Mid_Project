...
for (_, df_row) in df.iterrows():
    ...
    if df_row["ING_UNIT"] == "bol":
        amount = round(float(df_row["ING_AMOUNT"]) * 550 / 1000, 1)
        unit = 'kg'
    elif df_row["ING_UNIT"] == "can":
        amount = round(float(df_row["ING_AMOUNT"]) * 200 / 1000, 1)
        unit = 'kg'
    elif df_row["ING_UNIT"] == "cup":
        amount = round(float(df_row["ING_AMOUNT"]) * 200 / 1000, 1)
        unit = 'kg'
    elif df_row["ING_UNIT"] == "korea_gram":
        amount = round(float(df_row["ING_AMOUNT"]) * 600 / 1000, 1)
        unit = 'kg'
    elif df_row["ING_UNIT"] == "oz":
        amount = round(float(df_row["ING_AMOUNT"]) * 28 / 1000, 1)
        unit = 'kg'
    elif df_row["ING_UNIT"] == "soju":
        amount = round(float(df_row["ING_AMOUNT"]) * 50 / 1000, 1)
        unit = 'kg'
    elif df_row["ING_UNIT"] == "spoon":
        amount = round(float(df_row["ING_AMOUNT"]) * 15 / 1000, 1)
        unit = 'kg'
        ...
        amount = round(float(df_row["ING_AMOUNT"])/1000000, 1)
        unit = 'kg'
